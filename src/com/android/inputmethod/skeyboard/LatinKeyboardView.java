...
public class LatinKeyboardView extends LatinKeyboardBaseView {
    ...
    public void setKeyPreview(boolean showPreview) {
    	mKeyPreview = showPreview;
    }
    ...
    protected boolean onLongPress(Key key) {
    	...
    	if(getKeyboard() instanceof LatinKeyboard) {
    		final LatinKeyboard latinKeyboard = (LatinKeyboard)getKeyboard();
    		isPhoneKeyboard = (latinKeyboard.getKeyboardMode() == KeyboardSwitcher.MODE_PHONE);
    	}
        ...
        //} else if (primaryCode == '0' && getKeyboard() == mPhoneKeyboard) { // SMM
