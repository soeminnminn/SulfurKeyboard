...
public class LatinKeyboard extends Keyboard {
    ...
    void setImeOptions(Resources res, int mode, int options) {
        ...
        if (mEnterKey != null) {
            ...
            mEnterKey.icon = null;
            mEnterKey.iconId = KeyboardIconsSet.ICON_UNDEFINED;
            ...
            switch (options & (EditorInfo.IME_MASK_ACTION | EditorInfo.IME_FLAG_NO_ENTER_ACTION)) {
                ...
                case EditorInfo.IME_ACTION_SEARCH:
                    ...
                    mEnterKey.icon = mIconsSet.getIcon(KeyboardIconsSet.ICON_SEARCH_KEY);
                    break;
                ...
                default:
                    if (mode == KeyboardSwitcher.MODE_IM) {
                        mEnterKey.icon = mIconsSet.getIcon(KeyboardIconsSet.ICON_HINT_POPUP);
                        mEnterKey.label = ":-)";
                        mEnterKey.text = ":-) ";
                        ...
                        mEnterKey.icon = mIconsSet.getIcon(KeyboardIconsSet.ICON_RETURN_KEY);
                    }
                    break;
            }
    ...
    void setShiftLocked(boolean shiftLocked) {
        if (mShiftKey != null) {
            if (shiftLocked) {
                ...
                mShiftKey.icon = mIconsSet.getIcon(KeyboardIconsSet.ICON_SHIFT_KEY);
                mShiftKey.iconId = KeyboardIconsSet.ICON_UNDEFINED;
                mShiftState = SHIFT_LOCKED;
            } else {
                mShiftKey.on = false;
                //mShiftKey.icon = mShiftLockIcon;
                mShiftKey.icon = mIconsSet.getIcon(KeyboardIconsSet.ICON_SHIFTLOCKED_KEY);
                mShiftKey.iconId = KeyboardIconsSet.ICON_UNDEFINED;
    ...
    private void update123Key() {
        ...
        if (m123Key != null && mIsAlphaKeyboard) {
            if (mVoiceEnabled && !mHasVoiceButton) {
                ...
                m123Key.icon = mIconsSet.getIcon(KeyboardIconsSet.ICON_123MIC_KEY);
                m123Key.iconId = KeyboardIconsSet.ICON_UNDEFINED;
    ...
    private void setMicF1Key(Key key) {
    	...
    	final Drawable micIcon = mIconsSet.getIcon(KeyboardIconsSet.ICON_MIC_KEY);
    	final Drawable hintIcon = mIconsSet.getIcon(KeyboardIconsSet.ICON_HINT_POPUP);
        final Drawable micWithSettingsHintDrawable = new BitmapDrawable(mRes,
        ...
        key.iconId = KeyboardIconsSet.ICON_UNDEFINED;
    ...
    private void setNonMicF1Key(Key key, String label, int popupResId) {
        ...
        key.icon = mIconsSet.getIcon(KeyboardIconsSet.ICON_HINT_POPUP);
        key.iconId = KeyboardIconsSet.ICON_UNDEFINED;
    ...
    private void updateNumberHintKeys() {
        for (int i = 0; i < mNumberHintKeys.length; ++i) {
            if (mNumberHintKeys[i] != null) {
                ...
                mNumberHintKeys[i].iconId = KeyboardIconsSet.ICON_UNDEFINED;
            }
        }
    }
    ...
    public boolean isLanguageSwitchEnabled() {
        //return mLocale != null;
    	return ((mLocale != null) && (mMode != KeyboardSwitcher.MODE_PHONE) && (mMode != KeyboardSwitcher.MODE_NUMBER));
    }
    ...
    private void updateSpaceBarForLocale(boolean isAutoCompletion, boolean isBlack) {
    	...
    	final Drawable icon = mIconsSet.getIcon(KeyboardIconsSet.ICON_SPACE_KEY);
    	mSpaceKey.iconId = KeyboardIconsSet.ICON_UNDEFINED;
        if (mLocale != null) {
            mSpaceKey.icon = new BitmapDrawable(mRes, drawSpaceBar(icon, OPACITY_FULLY_OPAQUE, isAutoCompletion, isBlack));
        } else {
    ...
    private Bitmap drawSpaceBar(Drawable icon, int opacity, boolean isAutoCompletion, boolean isBlack) {
        ...
        if (isLanguageSwitchEnabled()) {
            ...
            final int shadowColor = mRes.getColor(isBlack
                    ? R.color.latinkeyboard_bar_language_shadow_dark
                    : R.color.latinkeyboard_bar_language_shadow_light);
            final float baseline = height * SPACEBAR_LANGUAGE_BASELINE;
            final float descent = paint.descent();
            paint.setColor(shadowColor);
            canvas.drawText(language, width / 2, baseline - descent - 1, paint);
            paint.setColor(mRes.getColor(isBlack 
            		? R.color.latinkeyboard_bar_language_text_dark 
            		: R.color.latinkeyboard_bar_language_text_light));
    ...
    public void setLanguageSwitcher(LanguageSwitcher switcher, boolean isAutoCompletion, boolean isBlack) { // SMM
        ...
        mLocale = locale;
        setColorOfSymbolIcons(isAutoCompletion, isBlack); // SMM
    }
    ...
    class SlidingLocaleDrawable extends Drawable {
        ...
        public SlidingLocaleDrawable(Drawable background, int width, int height) {
            ...
            mTextPaint.setColor(mContext.getResources().getColor(R.color.latinkeyboard_transparent));
            ...
            mLeftDrawable = mRes.getDrawable(R.drawable.ic_suggest_strip_scroll_left_arrow); // SMM
            mRightDrawable = mRes.getDrawable(R.drawable.ic_suggest_strip_scroll_right_arrow); // SMM
