...
package com.s16.picker.colorpicker;
...
import com.s16.picker.colorpicker.ColorPickerSwatch.OnColorSelectedListener;
...
public class ColorPickerDialog extends DialogFragment implements OnColorSelectedListener {
    ...
    public void setPositiveButton(int textId, final OnClickListener listener) {
        mPositiveButtonText = getActivity().getText(textId);
    ...
    public void setNegativeButton(int textId, final OnClickListener listener) {
        mNegativeButtonText = getActivity().getText(textId);
