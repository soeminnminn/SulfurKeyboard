...
import com.s16.inputmethod.skeyboard.KeyboardBaseView.OnKeyboardActionListener;
import com.s16.inputmethod.skeyboard.KeyboardBaseView.UIHandler;
...
public class PointerTracker {
    ...
    private boolean isModifierInternal(int keyIndex) {
        ...
        return primaryCode == KeyCodes.KEYCODE_SHIFT
                || primaryCode == KeyCodes.KEYCODE_MODE_CHANGE;
    }
    ...
    public boolean isSpaceKey(int keyIndex) {
        Key key = getKey(keyIndex);
        return key != null && key.codes[0] == KeyCodes.KEYCODE_SPACE;
    }
    ...
    public void onDownEvent(int x, int y, long eventTime) {
        ...
        if (mListener != null) {
            if (isValidKeyIndex(keyIndex)) {
            	...
            	mListener.onPress(mKeys[keyIndex].getCode()); // SMM
