...
public class Keyboard {
     ...
     * @attr ref android.R.styleable#Keyboard_Key_shiftLabel
     * @attr ref android.R.styleable#Keyboard_Key_capsLabel
     ...
     * @attr ref android.R.styleable#Keyboard_Key_isCursor
    ...
    public static class Key {
        ...
        public Key(Resources res, Row parent, int x, int y, XmlResourceParser parser) {
            ...
            if (shiftCodesValue.type == TypedValue.TYPE_INT_DEC 
                    || shiftCodesValue.type == TypedValue.TYPE_INT_HEX) {
                shiftCodes = new int[] { shiftCodesValue.data };
            ...
            iconId = a.getInt(R.styleable.Keyboard_Key_keyIconId, 0); // SMM
    ...
    final void resize(int newWidth, int newHeight) {
    	if (newWidth > 0 && newWidth != mTotalWidth) {
    ...
    private void loadKeyboard(Context context, XmlResourceParser parser) {
            ...
            while ((event = parser.next()) != XmlResourceParser.END_DOCUMENT) {
                if (event == XmlResourceParser.START_TAG) {
                    ...
                    if (TAG_ROW.equals(tag)) {
                        ...
                        mKeys.add(key);
                        if (key.codes[0] == KeyCodes.KEYCODE_SHIFT) {
                        ...
                        } else if (key.codes[0] == KeyCodes.KEYCODE_ALT) {
                            mModifierKeys.add(key);
                        }
        ...
        if(DEBUG) {
        	DisplayMetrics dm = context.getResources().getDisplayMetrics();
            //double srcWidthInches = Math.pow(dm.widthPixels/dm.xdpi,2);
            double srcHeightInches = Math.pow(dm.heightPixels/dm.ydpi,2);
            double totalHeightInches = Math.pow(mTotalHeight/dm.ydpi,2); // Total Height = 1.3in
            
            Log.i(TAG, "Screen Height : " + dm.heightPixels + " pixels, " + srcHeightInches + " inches;"
            		+ " Keyboard Height : " + mTotalHeight + " pixels, " + totalHeightInches + " inches;");
            
            float textSize = res.getDimensionPixelOffset(R.dimen.key_label_text_size);
            Paint paint = new Paint();
            paint.setTextSize(textSize);
            Rect textBounds = new Rect();
            paint.getTextBounds("H", 0, 1, textBounds);
            
            Log.i(TAG, "Text Size : " + textSize + "; width = " + textBounds.width() + "; height = " + textBounds.height());
        }
    }
